  ...
  const projects = [
    {
      title: "BatWerse",
      description:
        " Developed a responsive and interactive Batman fan website featuring character profiles, movie details, and smooth UI animations.",
      image: "./BatWerse.png",
      tags: ["React", "Tailwind"],
    },
    // {
        ...
        >
          <nav className="max-w-7xl mx-auto px-6 md:px-12 py-4 flex justify-between items-center backdrop-blur-md">
            ...
            <div
              ...
              } transition-transform duration-300 ease-in-out md:hidden flex flex-col justify-center items-center space-y-8 z-40 backdrop-blur-lg`}
              style={{
                backgroundColor:
                  theme === "light"
            ...
            <div className="max-w-7xl mx-auto z-10">
              <div className="flex flex-col items-center">
                ...
                <div className="flex flex-col sm:flex-row items-center gap-4 mb-8">
                  <a
                    href="/pgyPortfolio/Gokul_Yadav_Resume.pdf"
                  ...
                  <div className="flex space-x-4">
                    <a
                      href="https://github.com/pgyunknown"
                    ...
                    <a
                      href="https://www.linkedin.com/in/p-gokul-yadav-82548a295/"
                      className="p-3 rounded-full transition-all duration-300 hover:scale-110 shadow-md"
                      style={{ backgroundColor: currentColors.accent }}
                      target="_blank"
                    >
                    ...
                    <a
                      href="mailto:gokulyadavdev@gmail.com"
                      className="p-3 rounded-full transition-all duration-300 hover:scale-110 shadow-md"
                      style={{ backgroundColor: currentColors.accent }}
                      target="_blank"
                    >
                    ...
                    <a
                      href="https://x.com/pgy_javac?t=UBSuZpQB7zh9Ku0xIttmvw&s=09"
                      className="p-3 rounded-full transition-all duration-300 hover:scale-110 shadow-md"
                      style={{ backgroundColor: currentColors.accent }}
                      target="_blank"
                    >
                      <X style={{ color: currentColors.primary }} />
                    </a>
                  </div>
                </div>
            ...
            <div className="max-w-7xl mx-auto">
              ...
              <div className="grid md:grid-cols-2 gap-12 items-center">
                <div className="text-lg leading-relaxed text-justify">
                  <p className="mb-4">
                    Hello! I'm Gokul, a passionate Developer, eager to create
                    intuitive, and highly functional applications. My journey
                    into web development started with a fascination for how code
                    can work to create seamless user experiences, now my journey
                    has lead me to Java Backend.
                  </p>
                  <p>
                    When I’m not coding, you’ll find me binge-watching movies,
                    squeezing in quick workout sessions, going for walks, or
                ...
                {projects.map((project, index) => (
                  <div
                    ...
                    style={{
                      ...
                      width: projects.length === 1 ? "100%" : "auto",
                      maxWidth: projects.length === 1 ? "600px" : "none",
                    }}
                  >
                    <img
                      src={project.image}
