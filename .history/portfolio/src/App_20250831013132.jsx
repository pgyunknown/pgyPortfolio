            ...
            <div className="max-w-7xl mx-auto">
              ...
              <div className="grid md:grid-cols-2 gap-12 items-center">
                <div className="text-lg leading-relaxed text-justify">
                  <p className="mb-4">
                    Hello! I'm Gokul, a passionate Developer a knack for
                    creating intuitive, and highly functional applications. My
                    journey into web development started with a fascination for
                    how code can work to create seamless user experiences, now
                    my journey has lead me to Java Backend.
                  </p>
                  <p className="mb-4">
