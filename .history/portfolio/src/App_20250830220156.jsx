...
const Portfolio = () => {
  ...
  return (
    <div className="relative flex flex-col lg:flex-row min-h-screen">
      ...
      {/* Right Section */}
      <div className="w-full lg:w-1/2 bg-[#111111] text-white flex flex-col items-start justify-center p-8 sm:p-12 lg:p-20 relative overflow-hidden">
        {/* Desktop Header */}
        ...
        <div className="relative w-full max-w-sm sm:max-w-md mx-auto lg:mx-0">
          ...
          <div className="absolute -bottom-10 -left-10 text-white transform -rotate-45">
            <svg
              width="80"
              height="20"
              viewBox="0 0 200 50"
          ...
          <div className="relative w-full aspect-square rounded-full border-2 border-white p-2 animate-spin-slow">
