  ...
  const projects = [
    {
      title: "BatVerse",
      description:
        " Developed a responsive and interactive Batman fan website using React and TailwindCSS, featuring character profiles, movie details, and smooth UI animations.",
